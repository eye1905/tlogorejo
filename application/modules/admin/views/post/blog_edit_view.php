...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <form action="<?php echo site_url('admin/blog/update_blog') ?>" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="form-group col-md-8">
              ...
              <input type="text" name="judul" class="form-control" placeholder="Judul Postingan" autocomplete="off" value="<?php echo $judul ?>">
            </div>
            ...
            <div class="form-group col-md-4">
              ...
              <select name="id_kategori" class="form-control select2" style="width: 100%;">
                ...
                <option value="<?php echo $row->id ?>" <?php echo ($row->id == $id_kategori) ? 'selected' : '' ?>><?php echo $row->kategori ?></option>
                <?php endforeach; ?>
              </select>
            </div>
            ...
            <div class="form-group col-md-8">
              ...
              <textarea id="summernote" name="konten"><?php echo $konten ?></textarea>
            </div>
            ...
            <div class="form-group col-md-4">
              ...
              <a href="" class="btn btn-default"><i class="fa fa-eye"></i> Gambar</a>
            </div>
            ...
            <div class="form-group col-md-4">
              <div class="material-switch">
                <input id="check" type="checkbox" <?php echo ($status == 1) ? 'checked' : '' ?>/>
                <label for="check" name="status" class="label-primary"></label> &nbsp;Publikasikan
              </div>
            </div>

          </div>
          <input type="text" name="id" class="hidden" value="<?php echo $id ?>">
          <input type="submit" name="submit" class="hidden" id="submit-form">
        </form>
      </div>
