  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <div class="box-title">
          <a href="<?php echo site_url('admin/C_post') ?>" class="btn btn-sm btn-default btn-rounded"><i class="fa fa-chevron-left"></i> Kembali</a>
        </div>
      ...
      <div class="box-body">
        <div class="row">
          <div class="form-group col-md-8">
            ...
            <input type="text" name="judul" class="form-control" placeholder="Judul Postinganingan" autocomplete="off">
          </div>
          ...
          <div class="form-group col-md-4">
            <div class="material-switch">
              ...
              <label for="multiSelect" name="status" class="label-primary"></label> &nbsp;Publikasikan
            </div>
          </div>
