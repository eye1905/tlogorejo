          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="card mb-4">
              <div class="card-wrapper">
                <img class="card-img-top" src="<?php echo base_url("assets/img/upload/$row->artikel_image") ?>" alt="Card image cap">  
              </div>
              <div class="card-body">
                <h5 class="card-title"><?php echo limit_words($row->artikel_judul, 5) ?>...</h5>
                <p class="card-text"><?php echo limit_words($row->artikel_isi, 25) ?>...</p>
                <p class="card-text">
                  <small class="text-muted"><?php echo $row->artikel_tanggal ?> by <?php echo $row->artikel_author ?></small></p>
              </div>
